...
export default function Curriculum({ cleanCvData }) {
	const locale = 'fr';
			...
			<CvSection theme={theme}>
				...
				<div className='desc'>
					...
					<div className='xp_details'>
						Design de nouvelles features, rédaction d’user stories,
						refonte des emails transactionnels
					</div>
				</div>
			</CvSection>
			<CvSection theme={theme}>
				...
				<div className='desc'>
					...
					<div className='xp_details'>
						Création & déploiement des stratégies SEO & CRM dans 8
						pays, scénarios automatisés, implémentation d&apos;un
						RCU et d&apos;un NPS, suivi de KPIs, service client,
